...
let contaAndrei = new Conta("012", 123.00);
let ceAndrei = new Conta("120", 456.00);
let andreiCliente = new ClienteEspecial("Ândrei", "000.111.222-45", contaAndrei, ceAndrei);
console.log(andreiCliente);
console.log("Salto total deste cliente: R$", andreiCliente.saldoTotal());